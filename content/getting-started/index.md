...
Hugo itself is just a single binary without dependencies on expensive runtimes like Ruby, Python or PHP. Currently the only dependency is a [data provider](/data-providers) which hosts your geospatial data. Go ahead and download the [latest version](https://github.com/terranodo/tegola/releases).
